...
export function normalizeGroundEqSettings(value) {
...
export function readGroundEqSettingsStorage() {
...
export function applyGroundEqValue(value, curve, unit) {
